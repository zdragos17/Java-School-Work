...
public class BuyJPanel extends JPanel {
    ...
    private void initComponents(){
        ...
        buyButton.addActionListener(e -> {
            buyShares(symbolComboBox, quantityTextField, costTextField);
        });
    ...
    private void buyShares(JComboBox<String> symbolComboBox,
                           JTextField quantityTextField,
                           JTextField totalCostTextField){
        try {
            String symbol = (String) symbolComboBox.getSelectedItem();
            ...
            try {
                int quantity = Integer.parseInt(quantityTextField.getText());
                DecimalFormat formatter = new DecimalFormat("#,##0.##");
                this.mainFrame.getPortfolio().buyShares(symbol,quantity,stockPrice);
            } catch (NumberFormatException e) {
                totalCostTextField.setText("Invalid quantity value!");
            }
        } catch (IOException ex) {
