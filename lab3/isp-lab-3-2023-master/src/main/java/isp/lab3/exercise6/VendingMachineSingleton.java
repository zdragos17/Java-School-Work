...
public class VendingMachineSingleton {
    ...
    private VendingMachineSingleton(String[] products, int[] productPrices) {
    ...
    public static VendingMachineSingleton getInstance(String[] products, int[] productPrices) {
        if (instance == null) {
            synchronized (VendingMachineSingleton.class) {
                if (instance == null) {
                    instance = new VendingMachineSingleton(products, productPrices);
                }
            }
        }
        return instance;
